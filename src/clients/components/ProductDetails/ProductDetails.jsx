...
const product = {
    ...
    images: [
        {
            src: '/images/yajora.jpeg',
            alt: 'Two each of gray, white, and black shirts laying flat.',
        },
        {
            src: '/images/yajora1.jpeg',
            alt: 'Model wearing plain black basic tee.',
        },
        {
            src: '/images/lbni.jpeg',
        ...
        lg:pb-24">
                        ...
                        <div className="mt-4 lg:row-span-3 lg:mt-0">
                            ...
                            <div className='flex space-x-5 items-center text-lg lg:text-xl text-gray-900 mt-6'>
                                ...
                                <p className='text-green-600 font-semibold'>{products.product?.discountedPresent}% Off</p>
                            ...
                            <div className="mt-6">
                                <div className='flex items-center space-x-3'>
                                     ...
                                     <p className='opacity-50 text-sm'>25026 Ratings</p>
                                     <p className='ml-3 text-sm font-medium  text-indigo-600 
                                     hover:text-indigo-500'>3400 Reviews</p>
                                </div>
                            ...
                            <form className="mt-10">
                                ...
                                <Button onClick={handeAddToCart} variant="contained" sx={{px:"2rem",py:"1rem",
                            bgcolor:"#9155fd"}}>
                                       Add Au Panel
                                </Button>
                            </form>
              ...
              <section>
                ...
                <div className='border p-5'>
                    ...
                    <Grid item xs={5}>
                      <h1 className='text-x1 font-semibold pb-2'>produit rating</h1>
                      <div className='flex items-center space-x-3'>
                      ...
                      <Box className="mt-5 space-y-3" >
                        ...
                        <Grid container  alignItems="center" gap={2}>
                            ...
                            color:"yellow"}} variant="determinate" value={20} />
                            </Grid>
                        </Grid>
                     ...
                     <section className='pt-10'>
                      <h1 className='py-5 text-X1 font-bold'>Produits Similaire</h1>
                      <div className='flex flex-wrap space-y-5'>
                         {carr_produit.map((item)=> <HomeSectionCard product={item}/>)}
                      </div>
                     </section>
            </div>
        </div>
